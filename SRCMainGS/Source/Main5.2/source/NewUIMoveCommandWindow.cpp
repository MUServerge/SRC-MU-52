...
void SEASON3B::CNewUIMoveCommandWindow::RenderFrame()
{
	...
	RenderImageF(IMAGE_MOVECOMMAND_SCROLL_TOP, m_ScrollBarPos.x, m_ScrollBarPos.y, MOVECOMMAND_SCROLLBAR_TOP_WIDTH, MOVECOMMAND_SCROLLBAR_TOP_HEIGHT, 0.f, 0.f, 28.f, 12.f);
	...
	{
		RenderImageF(IMAGE_MOVECOMMAND_SCROLL_MIDDLE, m_ScrollBarPos.x, RenderFrameY, MOVECOMMAND_SCROLLBAR_TOP_WIDTH, MOVECOMMAND_SCROLLBAR_MIDDLE_HEIGHT, 0.f, 0.f, 28.f, 60.f);
	...
	if (render_spare > 0)
	{
		RenderImageF(IMAGE_MOVECOMMAND_SCROLL_MIDDLE, m_ScrollBarPos.x, RenderFrameY, MOVECOMMAND_SCROLLBAR_TOP_WIDTH, render_spare, 0.f, 0.f, 28.f, 60.f);
	}

	RenderImageF(IMAGE_MOVECOMMAND_SCROLL_BOTTOM, m_ScrollBarPos.x, m_ScrollBarPos.y + m_iScrollBarHeightPixel - MOVECOMMAND_SCROLLBAR_TOP_HEIGHT, MOVECOMMAND_SCROLLBAR_TOP_WIDTH, MOVECOMMAND_SCROLLBAR_TOP_HEIGHT, 0.f, 0.f, 28.f, 12.f);
	...
	if (m_bScrollBtnActive == true)
	{
		...
		RenderImageF(IMAGE_MOVECOMMAND_SCROLLBAR_ON, m_ScrollBtnPos.x, m_ScrollBtnPos.y,
			MOVECOMMAND_SCROLLBTN_WIDTH, MOVECOMMAND_SCROLLBTN_HEIGHT, 0.f, 0.f, 60.f, 120.f);
	}
	else
	{
		RenderImageF(IMAGE_MOVECOMMAND_SCROLLBAR_OFF, m_ScrollBtnPos.x, m_ScrollBtnPos.y,
			MOVECOMMAND_SCROLLBTN_WIDTH, MOVECOMMAND_SCROLLBTN_HEIGHT, 0.f, 0.f, 60.f, 120.f);
	}
