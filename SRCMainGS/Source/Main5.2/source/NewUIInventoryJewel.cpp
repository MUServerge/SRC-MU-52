...
void SEASON3B::CNewUIInventoryJewel::InitButtons()
{
	...
	{
		m_Button1.ChangeButtonImgState(true, CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY_VERY_SMALL, true, false, false, 0.f, 0.f, 216.f, 92.f);
		m_Button2.ChangeButtonImgState(true, CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY_VERY_SMALL, true, false, false, 0.f, 0.f, 216.f, 92.f);
...
void SEASON3B::CNewUIInventoryJewel::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_INVENTORY_BACK, this->m_Pos.x, this->m_Pos.y, 190.0, 429.0, 0.f, 0.f, (float)((190.0) * 4.f), (float)((429.0) * 4.f));

		RenderImageF(IMAGE_INVENTORY_BACK_TOP2, this->m_Pos.x, this->m_Pos.y, 190.0, 64.0, 0.f, 0.f, 760.f, 256.f);

		RenderImageF(IMAGE_INVENTORY_BACK_LEFT, (float)this->m_Pos.x, (float)(this->m_Pos.y + 64), 21.0, 320.0, 0.f, 0.f, 84.f, 1280.f);

		RenderImageF(IMAGE_INVENTORY_BACK_RIGHT, (float)(this->m_Pos.x + 169), (float)(this->m_Pos.y + 64), 21.0, 320.0, 0.f, 0.f, 84.f, 1280.f);

		RenderImageF(IMAGE_INVENTORY_BACK_BOTTOM, (float)this->m_Pos.x, (float)(this->m_Pos.y + 384), 190.0, 45.0, 0.f, 0.f, 760.f, 180.f);
	}

	RenderImageF(CNewUIInGameShop::IMAGE_IGS_STORAGE_PAGE, m_Pos.x + 66, this->m_Pos.y + 358.0, 58.0, 22.0, 0.0, 0.0, 320.0, 120.0);
