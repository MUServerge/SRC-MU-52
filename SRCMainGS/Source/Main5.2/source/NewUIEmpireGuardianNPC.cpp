...
void CNewUIEmpireGuardianNPC::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_EMPIREGUARDIAN_NPC_BTN, true, false, false, 0.f, 0.f, 216.f, 92.f );
...
bool CNewUIEmpireGuardianNPC::Render()
{
	...
	//{
	//	RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_LINE, m_Pos.x + 1, m_Pos.y + 220, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	//}
...
void CNewUIEmpireGuardianNPC::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_BACK, m_Pos.x, m_Pos.y, float(NPC_WINDOW_WIDTH), float(NPC_WINDOW_HEIGHT), 0.f, 0.f, (float)((float(NPC_WINDOW_WIDTH)) * 4.f), (float)((float(NPC_WINDOW_HEIGHT)) * 4.f));
		RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_TOP, m_Pos.x, m_Pos.y, float(NPC_WINDOW_WIDTH), 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_RIGHT, m_Pos.x + NPC_WINDOW_WIDTH - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_EMPIREGUARDIAN_NPC_BOTTOM, m_Pos.x, m_Pos.y + NPC_WINDOW_HEIGHT - 45, float(NPC_WINDOW_WIDTH), 45.f, 0.f, 0.f, 760.f, 180.f);
	}*/
	g_pRenderText->SetFont(g_hFontBold);
	g_pRenderText->SetTextColor(220, 220, 220, 255);
	g_pRenderText->SetBgColor(0, 0, 0, 0);
