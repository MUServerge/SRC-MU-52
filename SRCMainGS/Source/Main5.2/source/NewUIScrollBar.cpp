...
bool CNewUIScrollBar::Render()
{
	...
	RenderImageF(IMAGE_SCROLL_TOP, m_ptPos.x, m_ptPos.y, SCROLLBAR_TOP_WIDTH, SCROLLBAR_TOP_HEIGHT, 0.f, 0.f, 28.f, 12.f);

	for (int i = 0; i < m_iScrollBarMiddleNum; i++)
	{
		RenderImageF(IMAGE_SCROLL_MIDDLE, m_ptPos.x,
			m_ptPos.y + SCROLLBAR_TOP_HEIGHT + (i * SCROLLBAR_MIDDLE_HEIGHT), SCROLLBAR_TOP_WIDTH, SCROLLBAR_MIDDLE_HEIGHT, 0.f, 0.f, 28.f, 60.f);
	}

	if (m_iScrollBarMiddleRemainderPixel > 0)
	{
		RenderImageF(IMAGE_SCROLL_MIDDLE, m_ptPos.x, m_ptPos.y + SCROLLBAR_TOP_HEIGHT + (m_iScrollBarMiddleNum * SCROLLBAR_MIDDLE_HEIGHT), SCROLLBAR_TOP_WIDTH, m_iScrollBarMiddleRemainderPixel, 0.f, 0.f, 28.f, 60.f);
	}

	RenderImageF(IMAGE_SCROLL_BOTTOM, m_ptPos.x, m_ptPos.y + m_iHeight - SCROLLBAR_TOP_HEIGHT, SCROLLBAR_TOP_WIDTH, SCROLLBAR_TOP_HEIGHT, 0.f, 0.f, 28.f, 12.f);
	...
	if (m_bScrollBtnActive == true)
	{
		...
		RenderImageF(IMAGE_SCROLLBAR_ON, m_ptScrollBtnPos.x, m_ptScrollBtnPos.y, SCROLLBTN_WIDTH, SCROLLBTN_HEIGHT, 0.f, 0.f, 60.f, 120.f);
	}
	else
	{
		RenderImageF(IMAGE_SCROLLBAR_OFF, m_ptScrollBtnPos.x, m_ptScrollBtnPos.y, SCROLLBTN_WIDTH, SCROLLBTN_HEIGHT, 0.f, 0.f, 60.f, 120.f);
	}
