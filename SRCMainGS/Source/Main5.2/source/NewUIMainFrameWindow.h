...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_SLOT_SELECTED,
			IMAGE_SKILL_COOLDOWN_BEGIN = BITMAP_INTERFACE_IBERIA_COOLDOWN_BEGIN,
			IMAGE_SKILL_COOLDOWN_END = BITMAP_INTERFACE_IBERIA_COOLDOWN_END,
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_GAUGE_AG_EMPTY,	// UI_HUD_AG_Empty (Look-5)
			IMAGE_GAUGE_SD_EMPTY,	// UI_HUD_SD_Empty (Look-5)
		};
	...
	private:
		...
		bool HandleLook5MuHelperButton();
		bool HandleLook5HelperSettingsButton();
	private:
		float PosX;
		float PosY;
	public:
