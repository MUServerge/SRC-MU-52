...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_GUILDINFO_TOP_PIXEL		= BITMAP_GUILDINFO_BEGIN + 4,
			IMAGE_GUILDINFO_BOTTOM_PIXEL	= BITMAP_GUILDINFO_BEGIN + 5,
			IMAGE_GUILDINFO_LEFT_PIXEL		= BITMAP_GUILDINFO_BEGIN + 6,
			IMAGE_GUILDINFO_RIGHT_PIXEL		= BITMAP_GUILDINFO_BEGIN + 7,
			
			IMAGE_GUILDINFO_TOP_LEFT		= BITMAP_GUILDINFO_BEGIN + 8,
			IMAGE_GUILDINFO_TOP_RIGHT		= BITMAP_GUILDINFO_BEGIN + 9,
			IMAGE_GUILDINFO_BOTTOM_LEFT		= BITMAP_GUILDINFO_BEGIN + 10,
			IMAGE_GUILDINFO_BOTTOM_RIGHT	= BITMAP_GUILDINFO_BEGIN + 11,
