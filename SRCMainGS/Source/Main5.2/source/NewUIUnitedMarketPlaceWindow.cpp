...
#if MAIN_UPDATE > 603
	pNewUIButton->ChangeButtonImgState(true, BITMAP_msgbox_btn_empty_very_small, true, false, false, 0.0, 0.0, 216.f, 92.f);
#else
	pNewUIButton->ChangeButtonImgState(true, IMAGE_UNITEDMARKETPLACEWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f);
#endif
...
void CNewUIUnitedMarketPlaceWindow::RenderFrame()
{
	...
	//else
	//{
	//	RenderImageF(IMAGE_UNITEDMARKETPLACEWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
