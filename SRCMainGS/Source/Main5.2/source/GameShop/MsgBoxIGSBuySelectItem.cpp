...
{
	RenderImageF(IMAGE_IGS_MGSBOX_BACK,
		GetPos().x, GetPos().y, IMAGE_IGS_FRAME_WIDTH, IMAGE_IGS_FRAME_HEIGHT,
		0.0f, 0.0f, IMAGE_IGS_FRAME_TEXTURE_WIDTH, IMAGE_IGS_FRAME_TEXTURE_HEIGHT);
}
