...
void CNewUICastleWindow::InitButton(CNewUIButton* pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char* pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState(true, IMAGE_CASTLEWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f);
...
{
	RenderImageF(IMAGE_CASTLEWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_CASTLEWINDOW_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_CASTLEWINDOW_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_CASTLEWINDOW_RIGHT, m_Pos.x + INVENTORY_WIDTH - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_CASTLEWINDOW_BOTTOM, m_Pos.x, m_Pos.y + INVENTORY_HEIGHT - 45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
...
void CNewUICastleWindow::RenderOutlineUpper(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_TOP_RIGHT, ptOrigin.x + fBoxWidth + 4, ptOrigin.y - 4, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_TOP_PIXEL, ptOrigin.x + 25, ptOrigin.y - 4, fBoxWidth - 21, 14, 0.f, 0.f, (float)((fBoxWidth - 21) * 4.f), 56.f);
...
void CNewUICastleWindow::RenderOutlineLower(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_LEFT_PIXEL, ptOrigin.x + 12, ptOrigin.y + 9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_RIGHT_PIXEL, ptOrigin.x + fBoxWidth + 4, ptOrigin.y + 9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_BOTTOM_PIXEL, ptOrigin.x + 15, ptOrigin.y + 3, fBoxWidth - 2, 14, 0.f, 0.f, (float)((fBoxWidth - 2) * 4.f), 56.f);
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_BOTTOM_LEFT, ptOrigin.x + 12, ptOrigin.y + fBoxHeight + 3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_BOTTOM_RIGHT, ptOrigin.x + fBoxWidth + 4, ptOrigin.y + fBoxHeight + 3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_BOTTOM_PIXEL, ptOrigin.x + 25, ptOrigin.y + fBoxHeight + 3, fBoxWidth - 21, 14, 0.f, 0.f, (float)((fBoxWidth - 21) * 4.f), 56.f);
}
...
void CNewUICastleWindow::RenderTaxManagingTab()
{
	...
	RenderImageF(IMAGE_CASTLEWINDOW_TABLE_BOTTOM_PIXEL, ptOrigin.x + 15, ptOrigin.y + 30, 160 - 2, 14, 0.f, 0.f, (float)((160 - 2) * 4.f), 56.f);
	...
	ptOrigin.y += 18;
	RenderImageF(IMAGE_CASTLEWINDOW_MONEY, ptOrigin.x + 10, ptOrigin.y, 170.f, 24.f, 0.f, 0.f, 680.f, 96.f);
