...
{
	RenderImageF(IMAGE_IGS_BACK, m_Pos.x, m_Pos.y, IMAGE_IGS_BACK_WIDTH, IMAGE_IGS_BACK_HEIGHT, 0.f, 0.f, (float)((IMAGE_IGS_BACK_WIDTH) * 4.f), (float)((IMAGE_IGS_BACK_HEIGHT) * 4.f));
	...
	for (int i = 0; i < iSizeCategory - 1; i++)
	{
		...
		RenderImageF(IMAGE_IGS_CATEGORY_DECO_MIDDLE, CategoryDecoMiddlePos.x, CategoryDecoMiddlePos.y, IMAGE_IGS_CATEGORY_DECO_MIDDLE_WIDTH, IMAGE_IGS_CATEGORY_DECO_MIDDLE_HEIGHT, 0.f, 0.f, 6.f, 8.f);
	}

	// Category Deco Down Render
	RenderImageF(IMAGE_IGS_CATEGORY_DECO_DOWN, m_Pos.x, m_CategoryButton.GetPos(iSizeCategory - 1).y - 10, IMAGE_IGS_CATEGORY_DECO_DOWN_WIDTH, IMAGE_IGS_CATEGORY_DECO_DOWN_HEIGHT, 0.f, 0.f, 47.f, 100.f);

	for (int cnt = g_InGameShopSystem->GetSizePackageAsDisplayPackage(); cnt < INGAMESHOP_DISPLAY_ITEMLIST_SIZE; cnt++)
	{
		RenderImageF(IMAGE_IGS_ITEMBOX_LOGO, m_Pos.x + IMAGE_IGS_ITEMBOX_LOGO_POS_X + ((cnt % IGS_NUM_ITEMS_WIDTH) * IMAGE_IGS_VIEWDETAIL_BTN_DISTANCE_X), m_Pos.y + IMAGE_IGS_ITEMBOX_LOGO_POS_Y + ((cnt / IGS_NUM_ITEMS_HEIGHT) * IMAGE_IGS_VIEWDETAIL_BTN_DISTANCE_Y), IMAGE_IGS_ITEMBOX_LOGO_SIZE, IMAGE_IGS_ITEMBOX_LOGO_SIZE, 0.f, 0.f, 228.f, 228.f);
	}

	RenderImageF(IMAGE_IGS_STORAGE_PAGE, m_Pos.x + IMAGE_IGS_STORAGE_PAGE_POS_X, m_Pos.y + IMAGE_IGS_STORAGE_PAGE_POS_Y, IMGAE_IGS_STORAGE_PAGE_WIDTH, IMGAE_IGS_STORAGE_PAGE_HEIGHT, 0.f, 0.f, 320.f, 120.f);
}
...
void CNewUIInGameShop::SetBtnInfo()
{
	...
	m_ListBoxTabButton.ChangeImageSourceSize(196.0f, 40.0f);
	...
	for (int i = 0; i < INGAMESHOP_DISPLAY_ITEMLIST_SIZE; i++)
	{
		m_ViewDetailButton[i].ChangeButtonImgState(true, IMAGE_IGS_VIEWDETAIL_BTN, true, false, true, 0.f, 0.f, 208.f, 104.f);
	...
	m_CashGiftButton.ChangeButtonImgState(true, IMAGE_IGS_ITEMGIFT_BTN, true, false, false, 0.f, 0.f, 100.f, 100.f);
	...
	m_CashChargeButton.ChangeButtonImgState(true, IMAGE_IGS_CASHGIFT_BTN, true, false, false, 0.f, 0.f, 100.f, 100.f);
	...
	m_CashRefreshButton.ChangeButtonImgState(true, IMAGE_IGS_REFRESH_BTN, true, false, false, 0.f, 0.f, 100.f, 100.f);
	...
	m_UseButton.ChangeButtonImgState(true, IMAGE_IGS_VIEWDETAIL_BTN, true, false, true, 0.f, 0.f, 208.f, 104.f);
	...
	m_PrevButton.ChangeButtonImgState(true, IMAGE_IGS_PAGE_LEFT, true, false, false, 0.f, 0.f, 80.f, 92.f);
	...
	// next
	m_NextButton.ChangeButtonImgState(true, IMAGE_IGS_PAGE_RIGHT, true, false, false, 0.f, 0.f, 80.f, 92.f);
	...
	// Storage Page prev
	m_StoragePrevButton.ChangeButtonImgState(true, IMAGE_IGS_STORAGE_PAGE_LEFT, true, false, false, 0.f, 0.f, 80.f, 88.f);
	...
	// Storage Page next
	m_StorageNextButton.ChangeButtonImgState(true, IMAGE_IGS_STORAGE_PAGE_RIGHT, true, false, false, 0.f, 0.f, 80.f, 88.f);
...
void CNewUIInGameShop::InitZoneBtn()
{
	...
	m_ZoneButton.ChangeImageSourceSize(304.0f, 92.0f);
...
void CNewUIInGameShop::InitCategoryBtn()
{
	...
	m_CategoryButton.ChangeImageSourceSize(292.0f, 108.0f);
