...
{
	return static_cast<int>(GetPercenteLife() * 100.f);
}
...
float CHARACTER::GetPercenteLife()
{
	...
	return max(0.f, min(1.f, m_LifeCur / static_cast<float>(m_LifeMax)));
}

DWORD CHARACTER::GetCurrentLife() const
{
	return m_LifeCur;
}

DWORD CHARACTER::GetMaximumLife() const
{
	return m_LifeMax;
}

WORD CHARACTER::GetMonsterLevel() const
{
	return m_MonsterLevel;
}

void CHARACTER::SetMonsterLevel(WORD level)
{
