...
void SEASON3B::CNewUIKanturu2ndEnterNpc::SetButtonInfo()
{
	...
	m_BtnRefresh.ChangeButtonImgState(true, IMAGE_KANTURU2ND_BTN, true, false, false, 0.f, 0.f, 216.f, 92.f);
	...
	m_BtnEnter.ChangeButtonImgState(true, IMAGE_KANTURU2ND_BTN, true, false, false, 0.f, 0.f, 216.f, 92.f);
	...
	m_BtnClose.ChangeButtonImgState(true, IMAGE_KANTURU2ND_BTN, true, false, false, 0.f, 0.f, 216.f, 92.f);
...
void SEASON3B::CNewUIKanturu2ndEnterNpc::RenderFrame()
{
	...
	RenderImageF(IMAGE_KANTURU2ND_BACK, x, y, width, height, 0.f, 0.f, (float)((width) * 4.f), (float)((height) * 4.f));

	x = m_Pos.x; y = m_Pos.y, width = MSGBOX_WIDTH; height = MSGBOX_TOP_HEIGHT;
	RenderImageF(IMAGE_KANTURU2ND_TOP, x, y, width, height, 0.f, 0.f, (float)((width) * 4.f), (float)((height) * 4.f));

	x = m_Pos.x; y += MSGBOX_TOP_HEIGHT; width = MSGBOX_WIDTH; height = MSGBOX_MIDDLE_HEIGHT;
	for(int i=0; i<10; ++i)
	{
		RenderImageF(IMAGE_KANTURU2ND_MIDDLE, x, y, width, height, 0.f, 0.f, (float)((width) * 4.f), (float)((height) * 4.f));
		y += height;
	}
	
	x = m_Pos.x; width = MSGBOX_WIDTH; height = MSGBOX_BOTTOM_HEIGHT;
	RenderImageF(IMAGE_KANTURU2ND_BOTTOM, x, y, width, height, 0.f, 0.f, (float)((width) * 4.f), (float)((height) * 4.f));
}
