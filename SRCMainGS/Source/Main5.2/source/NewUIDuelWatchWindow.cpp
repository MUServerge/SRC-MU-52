...
void CNewUIDuelWatchWindow::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_DUELWATCHWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f );
...
bool CNewUIDuelWatchWindow::Render()
{
	...
	RenderImageF(IMAGE_DUELWATCHWINDOW_LINE, m_Pos.x+1, m_Pos.y+130, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	RenderImageF(IMAGE_DUELWATCHWINDOW_LINE, m_Pos.x+1, m_Pos.y+130+90, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	RenderImageF(IMAGE_DUELWATCHWINDOW_LINE, m_Pos.x+1, m_Pos.y+130+90+90, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
...
{
	RenderImageF(IMAGE_DUELWATCHWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_DUELWATCHWINDOW_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_DUELWATCHWINDOW_LEFT, m_Pos.x, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_DUELWATCHWINDOW_RIGHT, m_Pos.x+INVENTORY_WIDTH-21, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_DUELWATCHWINDOW_BOTTOM, m_Pos.x, m_Pos.y+INVENTORY_HEIGHT-45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
