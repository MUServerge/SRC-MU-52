...
bool CNewUINPCQuest::Create(CNewUIManager* pNewUIMng, CNewUI3DRenderMng* pNewUI3DRenderMng, int x, int y)
{
	...
	m_btnComplete.ChangeButtonImgState(true, IMAGE_NPCQUEST_BTN_COMPLETE, true, false, false, 0.f, 0.f, 432.f, 116.f);
...
bool CNewUINPCQuest::Render()
{
	...
	if (QUEST_ING == byCurQuestState)
	{
		if (!gmProtect->checkold_school())
		{
			RenderImageF(IMAGE_NPCQUEST_LINE, m_Pos.x + 1, m_Pos.y + 325, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
		}
	...
	{
		RenderImageF(IMAGE_NPCQUEST_ZEN, m_Pos.x + 11, m_Pos.y + 361, 170.f, 24.f, 0.f, 0.f, 680.f, 96.f);
...
void CNewUINPCQuest::RenderBackImage(BYTE byCurQuestState)
{
	...
	{
		RenderImageF(IMAGE_NPCQUEST_LINE, m_Pos.x + 1, m_Pos.y + 220, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	}
#else
	if (QUEST_ING == byCurQuestState)
	{
