...
bool SEASON3B::CNewUIGuildInfoWindow::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	{
		m_Button[i].ChangeButtonImgState( true, IMAGE_GUILDINFO_BUTTON, true, false, false, 0.f, 0.f, 256.f, 116.f );
...
void SEASON3B::CNewUIGuildInfoWindow::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_GUILDINFO_BACK, m_Pos.x, m_Pos.y, GUILDINFO_WIDTH, GUILDINFO_HEIGHT, 0.f, 0.f, (float)((GUILDINFO_WIDTH) * 4.f), (float)((GUILDINFO_HEIGHT) * 4.f));
		RenderImageF(IMAGE_GUILDINFO_TOP, m_Pos.x, m_Pos.y, GUILDINFO_WIDTH, 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_GUILDINFO_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_GUILDINFO_RIGHT, m_Pos.x + GUILDINFO_WIDTH - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_GUILDINFO_BOTTOM, m_Pos.x, m_Pos.y + GUILDINFO_HEIGHT - 45, GUILDINFO_WIDTH, 45.f, 0.f, 0.f, 760.f, 180.f);
	}
}
...
void SEASON3B::CNewUIGuildInfoWindow::Render_Guild_History()
{
	...
	RenderImageF(IMAGE_GUILDINFO_SCROLL_TOP, m_Pos.x+167,
		262, 7, 3, 0.f, 0.f, 28.f, 12.f);
		
	for(int i=0; i<7; i++)
	{
		RenderImageF(IMAGE_GUILDINFO_SCROLL_MIDDLE, m_Pos.x+167,
			261+(float)(i*10+4), 7, 15, 0.f, 0.f, 28.f, 60.f);
	}
	
	RenderImageF(IMAGE_GUILDINFO_SCROLL_BOTTOM, m_Pos.x+167, 338, 7, 3, 0.f, 0.f, 28.f, 12.f);
	...
	RenderImageF(IMAGE_GUILDINFO_SCROLLBAR_ON, m_Pos.x+163, 262 + m_Loc, 15, 30, 0.f, 0.f, 60.f, 120.f);
...
void SEASON3B::CNewUIGuildInfoWindow::RenderScrollBar()
{
	...
	RenderImageF(IMAGE_GUILDINFO_SCROLL_TOP, m_Pos.x+170, 125, 7, 3, 0.f, 0.f, 28.f, 12.f);
	
	for(int i=0; i<22; i++)
		RenderImageF(IMAGE_GUILDINFO_SCROLL_MIDDLE, m_Pos.x+170, 124+(float)(i*10+4), 7, 15, 0.f, 0.f, 28.f, 60.f);
	
	RenderImageF(IMAGE_GUILDINFO_SCROLL_BOTTOM, m_Pos.x+170, 352, 7, 3, 0.f, 0.f, 28.f, 12.f);
	...
	if (m_EventState == EVENT_SCROLL_BTN_DOWN) 
		...
		glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
	RenderImageF(IMAGE_GUILDINFO_SCROLLBAR_ON, m_Pos.x+166, 125 + m_Loc, 15, 30, 0.f, 0.f, 60.f, 120.f);
