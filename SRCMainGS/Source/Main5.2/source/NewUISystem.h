...
namespace SEASON3B
{
	...
	private:
		...
		CNewUIQuestInfoHUD*				m_pNewQuestInfoHUD;
	...
	public:
		...
		CNewUIQuestInfoHUD* GetUI_NewQuestInfoHUD() const;
...
#define g_pQuestInfoHUD SEASON3B::CNewUISystem::GetInstance()->GetUI_NewQuestInfoHUD()
