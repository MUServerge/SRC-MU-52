...
public:
	...
	DWORD GetMaxLevel();
	DWORD ConvertLevel(DWORD Level);
public:
	char m_LicenseName[32];
	char m_CustomerName[32];
	char m_CustomerHardwareId[36];
	char m_ServerName[32];
	long m_ServerCode;
	long m_ServerLock;
	int m_AccountLevelLock[MAX_ACCOUNT_LEVEL];
	...
	int  m_ServerLeveAddMaster;
	int  m_MaxLevelCharacter;
	...
	int m_CastleSiegeSeniorMixLimitType;
	int m_CastleSiegeSeniorMixQuantityLimit;
	...
	int m_ClassReflectDamageRatePvP[MAX_CLASS];
	int m_ClassReflectDamageRatePvM[MAX_CLASS];
	...
	int m_GLDamageMultiplierConstA;
	int m_SLDamageMultiplierConstA;
	int m_GLDamageMultiplierMaxRate;
	int m_SLDamageMultiplierMaxRate;
	...
	//--
	int m_GLPlasmaStormDamageConstA;
	int m_GLPlasmaStormDamageConstB;
	int m_GLPlasmaStormDamageConstC;
	int m_GLPlasmaStormDamageConstD;
	int m_RWPlasmaStormDamageConstA;
	int m_RWPlasmaStormDamageConstB;
	int m_RWPlasmaStormDamageConstC;
	int m_RWPlasmaStormDamageConstD;
	int m_SLPlasmaStormDamageConstA;
	int m_SLPlasmaStormDamageConstB;
	int m_SLPlasmaStormDamageConstC;
	int m_SLPlasmaStormDamageConstD;
	int m_GCPlasmaStormDamageConstA;
	int m_GCPlasmaStormDamageConstB;
	int m_GCPlasmaStormDamageConstC;
	int m_GCPlasmaStormDamageConstD;
	//--
	...
	//--
	int m_GLPhysiDamageMinConstA;
	int m_GLPhysiDamageMaxConstA;
	int m_GLMagicDamageMinConstA;
	int m_GLMagicDamageMaxConstA;
	int m_RWPhysiDamageMinConstA;
	int m_RWPhysiDamageMaxConstA;
	int m_RWMagicDamageMinConstA;
	int m_RWMagicDamageMaxConstA;
	//--
	int m_SLPhysiDamageMinConstA;
	int m_SLPhysiDamageMaxConstA;
	int m_SLMagicDamageMinConstA;
	int m_SLMagicDamageMaxConstA;
	int m_GCPhysiDamageMinConstA;
	int m_GCPhysiDamageMaxConstA;
	int m_GCMagicDamageMinConstA;
	int m_GCMagicDamageMaxConstA;
	//--
	...
	//--
	int m_GLAttackSuccessRateConstA;
	int m_GLAttackSuccessRateConstB;
	int m_GLAttackSuccessRateConstC;
	int m_GLAttackSuccessRateConstD;
	int m_RWAttackSuccessRateConstA;
	int m_RWAttackSuccessRateConstB;
	int m_RWAttackSuccessRateConstC;
	int m_RWAttackSuccessRateConstD;
	int m_SLAttackSuccessRateConstA;
	int m_SLAttackSuccessRateConstB;
	int m_SLAttackSuccessRateConstC;
	int m_SLAttackSuccessRateConstD;
	int m_GCAttackSuccessRateConstA;
	int m_GCAttackSuccessRateConstB;
	int m_GCAttackSuccessRateConstC;
	int m_GCAttackSuccessRateConstD;
	//--
	...
	//--
	int m_GLAttackSuccessRatePvPConstA;
	int m_GLAttackSuccessRatePvPConstB;
	int m_GLAttackSuccessRatePvPConstC;
	int m_GLAttackSuccessRatePvPConstD;
	int m_RWAttackSuccessRatePvPConstA;
	int m_RWAttackSuccessRatePvPConstB;
	int m_RWAttackSuccessRatePvPConstC;
	int m_RWAttackSuccessRatePvPConstD;
	int m_SLAttackSuccessRatePvPConstA;
	int m_SLAttackSuccessRatePvPConstB;
	int m_SLAttackSuccessRatePvPConstC;
	int m_SLAttackSuccessRatePvPConstD;
	int m_GCAttackSuccessRatePvPConstA;
	int m_GCAttackSuccessRatePvPConstB;
	int m_GCAttackSuccessRatePvPConstC;
	int m_GCAttackSuccessRatePvPConstD;
	//--
	...
	//--
	int m_GLPhysiSpeedConstA;
	int m_GLMagicSpeedConstA;
	int m_RWPhysiSpeedConstA;
	int m_RWMagicSpeedConstA;
	int m_SLPhysiSpeedConstA;
	int m_SLMagicSpeedConstA;
	int m_GCPhysiSpeedConstA;
	int m_GCMagicSpeedConstA;
	//--
	...
	//--
	int m_GLDefenseSuccessRateConstA;
	int m_RWDefenseSuccessRateConstA;
	int m_SLDefenseSuccessRateConstA;
	int m_GCDefenseSuccessRateConstA;
	...
	//--
	int m_GLDefenseSuccessRatePvPConstA;
	int m_GLDefenseSuccessRatePvPConstB;
	int m_GLDefenseSuccessRatePvPConstC;
	int m_RWDefenseSuccessRatePvPConstA;
	int m_RWDefenseSuccessRatePvPConstB;
	int m_RWDefenseSuccessRatePvPConstC;
	int m_SLDefenseSuccessRatePvPConstA;
	int m_SLDefenseSuccessRatePvPConstB;
	int m_SLDefenseSuccessRatePvPConstC;
	int m_GCDefenseSuccessRatePvPConstA;
	int m_GCDefenseSuccessRatePvPConstB;
	int m_GCDefenseSuccessRatePvPConstC;
	//--
	...
	//--
	int m_GLDefenseConstA;
	int m_RWDefenseConstA;
	int m_SLDefenseConstA;
	int m_GCDefenseConstA;
	//--
	...
	long m_AnnounceChaosMixLevel;
	char m_AnnounceChaosMixSuccess[100];
	char m_AnnounceChaosMixFailed[100];
	// REI DO MU
	int m_ReiDoMUEvent;
	int m_ReiDoMUMap;
	int m_ReiDoMUCordX;
	...
	//--Chat System Anti Spam Settings
	int m_SwitchChatAntiSpam;
	int m_ChatAntiSpamTimeBlock;
	int m_ChatAntiSpamMaxMessage;
	int m_ChatAntiSpamTimeCheck;
	...
	int m_PkItemDropRaven;
	int m_PkItemDropHorse;
	int m_PkItemDropFenrir;
	...
	//buy inventory extension
#ifdef INVENTORY_EXT_BUY
	int m_SwitchBuyInventoryExt;
	int m_InventoryExtMsg[3];
	DWORD m_PriceInventoryExt[4];
