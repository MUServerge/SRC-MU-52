...
void SEASON3B::CNewUIMacroSub::RenderGroupBox(int x, int y, int width, int height, int headwidth, int headheight)
{
	...
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_TOP_RIGHT, (x + headwidth - 14), y, 14.0, 14.0, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_TOP_RIGHT, (x + width - 14), (headheight + y), 14.0, 14.0, 0.f, 0.f, 56.f, 56.f);

	RenderImageF(IMAGE_MACRO_MAIN_TABLE_BOTTOM_LEFT, x, (y + height - 14), 14.0, 14.0, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_BOTTOM_RIGHT, (x + width - 14), (y + height - 14), 14.0, 14.0, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_TOP_PIXEL, (x + 6), y, (headwidth - 12), 14.0, 0.f, 0.f, (float)(((headwidth - 12)) * 4.f), 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_TOP_PIXEL, (x + 3), (headheight + y), (headwidth - 8), 14.0, 0.f, 0.f, (float)(((headwidth - 8)) * 4.f), 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_RIGHT_PIXEL, (x + headwidth - 14), (y + 6), 14.0, (headheight - 6), 0.f, 0.f, 56.f, (float)(((headheight - 6)) * 4.f));
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_TOP_PIXEL, (x + headwidth - 5), (headheight + y), (width - headwidth - 6), 14.0, 0.f, 0.f, (float)(((width - headwidth - 6)) * 4.f), 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_RIGHT_PIXEL, (x + width - 14), (y + headheight + 6), 14.0, (height - headheight - 14), 0.f, 0.f, 56.f, (float)(((height - headheight - 14)) * 4.f));
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_BOTTOM_PIXEL, (x + 6), (y + height - 14), (width - 12), 14.0, 0.f, 0.f, (float)(((width - 12)) * 4.f), 56.f);
	RenderImageF(IMAGE_MACRO_MAIN_TABLE_LEFT_PIXEL, x, (y + 6), 14.0, (height - 14), 0.f, 0.f, 56.f, (float)(((height - 14)) * 4.f));
#endif
}
...
void SEASON3B::CNewUIMacroSub::AddButton(CNewUIButton* btn, int imgindex, int x, int y, int sx, int sy, bool overflg, bool isimgwidth, bool bClickEffect, bool MoveTxt, const char* btname, const char* tooltiptext, bool istoppos)
{
	...
	if (imgindex == IMAGE_IGS_VIEWDETAIL_BTN)
	{
		btn->ChangeButtonImgState(true, IMAGE_IGS_VIEWDETAIL_BTN, overflg, isimgwidth, bClickEffect, 0.f, 0.f, 208.f, 104.f);
	}
	else
	{
		btn->ChangeButtonImgState(true, imgindex, overflg, isimgwidth, bClickEffect);
