...
void CNewUIGuardWindow::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_GUARDWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f );
...
{
	RenderImageF(IMAGE_GUARDWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_GUARDWINDOW_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_GUARDWINDOW_LEFT, m_Pos.x, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GUARDWINDOW_RIGHT, m_Pos.x+INVENTORY_WIDTH-21, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GUARDWINDOW_BOTTOM, m_Pos.x, m_Pos.y+INVENTORY_HEIGHT-45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
...
void CNewUIGuardWindow::RenderRegisterInfoTab()
{
	...
	{
		EnableAlphaTest();
		RenderImageF(IMAGE_GUARDWINDOW_LEFT_PIXEL, ptOrigin.x+11, ptOrigin.y-14, 14, 255, 0.f, 0.f, 56.f, (float)((255) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_RIGHT_PIXEL, ptOrigin.x+166, ptOrigin.y-14, 14, 255, 0.f, 0.f, 56.f, (float)((255) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_TOP_PIXEL, ptOrigin.x+14, ptOrigin.y-14, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);
		RenderImageF(IMAGE_GUARDWINDOW_BOTTOM_PIXEL, ptOrigin.x+14, ptOrigin.y+232, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);
		DisableAlphaBlend();
	...
	{
		EnableAlphaTest();
		RenderImageF(IMAGE_GUARDWINDOW_LEFT_PIXEL, ptOrigin.x+11, ptOrigin.y-14, 14, 215, 0.f, 0.f, 56.f, (float)((215) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_RIGHT_PIXEL, ptOrigin.x+166, ptOrigin.y-14, 14, 215, 0.f, 0.f, 56.f, (float)((215) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_TOP_PIXEL, ptOrigin.x+14, ptOrigin.y-14, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);
		RenderImageF(IMAGE_GUARDWINDOW_BOTTOM_PIXEL, ptOrigin.x+14, ptOrigin.y+192, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);

		RenderImageF(IMAGE_GUARDWINDOW_LEFT_PIXEL, ptOrigin.x+11, ptOrigin.y+220, 14, 25, 0.f, 0.f, 56.f, (float)((25) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_RIGHT_PIXEL, ptOrigin.x+166, ptOrigin.y+220, 14, 25, 0.f, 0.f, 56.f, (float)((25) * 4.f));
		RenderImageF(IMAGE_GUARDWINDOW_TOP_PIXEL, ptOrigin.x+14, ptOrigin.y+220, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);
		RenderImageF(IMAGE_GUARDWINDOW_BOTTOM_PIXEL, ptOrigin.x+14, ptOrigin.y+237, 161, 14, 0.f, 0.f, (float)((161) * 4.f), 56.f);
		DisableAlphaBlend();
...
{
	RenderImageF(IMAGE_GUARDWINDOW_SCROLL_TOP, iPos_x, iPos_y, 7, 3, 0.f, 0.f, 28.f, 12.f);
	...
	for(int i=0; i<_iMiddle_Cnt; i++)
		RenderImageF(IMAGE_GUARDWINDOW_SCROLL_MIDDLE, iPos_x, iPos_y+(float)(i*_Temp+3), 7, _Temp, 0.f, 0.f, 28.f, 60.f);

	RenderImageF(IMAGE_GUARDWINDOW_SCROLL_MIDDLE, iPos_x, iPos_y+(float)(_iMiddle_Cnt*_Temp+3), 7, _Temp*_Middle_rest, 0.f, 0.f, 28.f, 60.f);
#else //PBG_ADD_INGAMESHOP_UI_ITEMSHOP
	RenderImageF(IMAGE_GUARDWINDOW_SCROLL_MIDDLE, iPos_x, iPos_y+3, 7.f, iHeight - 6, 0.f, 0.f, 28.f, 60.f);
#endif //PBG_ADD_INGAMESHOP_UI_ITEMSHOP
	RenderImageF(IMAGE_GUARDWINDOW_SCROLL_BOTTOM, iPos_x, iPos_y + iHeight - 3, 7, 3, 0.f, 0.f, 28.f, 12.f);
}
...
void CNewUIGuardWindow::RenderScrollBar(int iPos_x, int iPos_y, BOOL bIsClicked)
{
	if (bIsClicked)
	{
		...
		RenderImageF(IMAGE_GUARDWINDOW_SCROLLBAR_ON, iPos_x, iPos_y, 15, 30, 0.f, 0.f, 60.f, 120.f);
	}
	else
	{
		glColor3ub(255, 255, 255);
		RenderImageF(IMAGE_GUARDWINDOW_SCROLLBAR_OFF, iPos_x, iPos_y, 15, 30, 0.f, 0.f, 60.f, 120.f);
	}
	glColor3ub(255, 255, 255);
}
