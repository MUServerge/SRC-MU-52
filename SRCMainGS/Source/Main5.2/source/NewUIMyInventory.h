...
namespace SEASON3B
{
	...
	protected:
		...
		void SetEquipmentInfo(EQUIPMENT_ITEM* Equipment, int index, int imageindex, int x, int y, int width, int height, float su, float sv, float uw, float vh);
