...
void CMsgBoxIGSUseItemConfirm::RenderFrame()
{
	...
	RenderImageF(IMAGE_IGS_BACK, GetPos().x, GetPos().y, IMAGE_IGS_FRAME_WIDTH, IMAGE_IGS_FRAME_HEIGHT, 0.f, 0.f, (float)((IMAGE_IGS_FRAME_WIDTH) * 4.f), (float)((IMAGE_IGS_FRAME_HEIGHT) * 4.f));
