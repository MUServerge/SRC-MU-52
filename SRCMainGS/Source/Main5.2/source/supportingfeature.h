...
#define MAX_CUSTOM_NPC_ICON					100
...
// Over-head NPC icon mapping (NPC MonsterIndex -> icon file in
// Data\Interface\NpcIcons\). WorldIndex -1 = any map. OffsetY shifts the icon
// up/down over the head; Scale is the on-screen icon size in pixels.
