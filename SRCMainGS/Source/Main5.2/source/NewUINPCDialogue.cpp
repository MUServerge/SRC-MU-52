...
/*#if MAIN_UPDATE > 303
	...
	{
		RenderImageF(IMAGE_ND_BACK, m_Pos.x, m_Pos.y, float(ND_WIDTH), float(ND_HEIGHT), 0.f, 0.f, (float)((float(ND_WIDTH)) * 4.f), (float)((float(ND_HEIGHT)) * 4.f));
		RenderImageF(IMAGE_ND_TOP, m_Pos.x, m_Pos.y, float(ND_WIDTH), 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_ND_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_ND_RIGHT, m_Pos.x + ND_WIDTH - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_ND_BOTTOM, m_Pos.x, m_Pos.y + ND_HEIGHT - 45, float(ND_WIDTH), 45.f, 0.f, 0.f, 760.f, 180.f);

		RenderImageF(IMAGE_ND_LINE, m_Pos.x + 1, m_Pos.y + 181, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	}
#else
	RenderInventoryInterface(m_Pos.x, m_Pos.y, 191);
#endif*/
