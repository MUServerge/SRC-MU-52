...
bool CNewUIGuildMakeWindow::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	for( int i = 0; i < GUILDMAKEBUTTON_COUNT; ++i )
	{
		if( i == 0 )
		{
			m_Button[i].ChangeButtonImgState( true, IMAGE_GUILDMAKE_MAKEBUTTON, true, false, false, 0.f, 0.f, 432.f, 116.f );
			m_Button[i].ChangeButtonInfo( 0, 0, 108, 29 );
		}
		else
		{
			m_Button[i].ChangeButtonImgState( true, IMAGE_GUILDMAKE_NEXTBUTTON, true, false, false, 0.f, 0.f, 256.f, 116.f );
...
void CNewUIGuildMakeWindow::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_GUILDMAKE_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
		RenderImageF(IMAGE_GUILDMAKE_BACK_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_GUILDMAKE_BACK_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_GUILDMAKE_BACK_RIGHT, m_Pos.x + 190 - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_GUILDMAKE_BACK_BOTTOM, m_Pos.x, m_Pos.y + 429 - 45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
	}
	char Text[100];
	memset(&Text, 0, sizeof(char)*100);
