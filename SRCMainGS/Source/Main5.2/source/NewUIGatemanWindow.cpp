...
void CNewUIGatemanWindow::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_GATEMANWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f );
...
void CNewUIGatemanWindow::RenderFrame()
{
	...
	//RenderImageF(IMAGE_GATEMANWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
