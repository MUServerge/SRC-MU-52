...
bool SEASON3B::CNewUIMyQuestInfoWindow::Render()
{
	...
	if (m_eTabBtnIndex == TAB_QUEST)
	{
		...
		if (!gmProtect->checkold_school())
		{
			RenderImageF(IMAGE_MYQUEST_LINE, m_Pos.x, m_Pos.y + 160, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
		}
#endif
		RenderQuestInfo();
	}
	else if (m_eTabBtnIndex == TAB_JOB_CHANGE)
	{
		...
		if (!gmProtect->checkold_school())
		{
			RenderImageF(IMAGE_MYQUEST_LINE, m_Pos.x, m_Pos.y + 182, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
		}
#endif
	...
	else if (m_eTabBtnIndex == TAB_CASTLE_TEMPLE)
	{
		...
		if (!gmProtect->checkold_school())
		{
			RenderImageF(IMAGE_MYQUEST_LINE, m_Pos.x, m_Pos.y + 210, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
		}
#endif
		RenderCastleInfo();
		RenderTempleInfo();
...
void SEASON3B::CNewUIMyQuestInfoWindow::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_MYQUEST_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
		RenderImageF(IMAGE_MYQUEST_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_MYQUEST_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_MYQUEST_RIGHT, m_Pos.x + 190 - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_MYQUEST_BOTTOM, m_Pos.x, m_Pos.y + 429 - 45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
	}
#else
	if (m_eTabBtnIndex == TAB_QUEST)
	{
