...
bool CNewUIExchangeLuckyCoin::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	// Exchange Button
#if MAIN_UPDATE > 603
	m_BtnExit.ChangeButtonImgState(true, BITMAP_msgbox_btn_empty_small, true, false, false, 0.0, 0.0, 256.f, 116.f);
	m_BtnExchange[0].ChangeButtonImgState(true, BITMAP_msgbox_btn_empty, true, false, false, 0.0, 0.0, 432.f, 116.f);
	m_BtnExchange[1].ChangeButtonImgState(true, BITMAP_msgbox_btn_empty, true, false, false, 0.0, 0.0, 432.f, 116.f);
	m_BtnExchange[2].ChangeButtonImgState(true, BITMAP_msgbox_btn_empty, true, false, false, 0.0, 0.0, 432.f, 116.f);
	...
	{
		m_BtnExit.ChangeButtonImgState(true, IMAGE_EXCHANGE_LUCKYCOIN_WINDOW_BTN_EXIT, true, false, false, 0.f, 0.f, 256.f, 116.f);
	...
	{
		m_BtnExit.ChangeButtonImgState(true, IMAGE_EXCHANGE_LUCKYCOIN_WINDOW_BTN_EXIT, true, false, false, 0.f, 0.f, 256.f, 116.f);
		m_BtnExchange[0].ChangeButtonImgState(true, IMAGE_EXCHANGE_LUCKYCOIN_EXCHANGE_BTN, true, false, false, 0.f, 0.f, 432.f, 116.f);
		m_BtnExchange[1].ChangeButtonImgState(true, IMAGE_EXCHANGE_LUCKYCOIN_EXCHANGE_BTN, true, false, false, 0.f, 0.f, 432.f, 116.f);
		m_BtnExchange[2].ChangeButtonImgState(true, IMAGE_EXCHANGE_LUCKYCOIN_EXCHANGE_BTN, true, false, false, 0.f, 0.f, 432.f, 116.f);
...
void CNewUIExchangeLuckyCoin::RenderFrame()
{
	...
	//RenderImageF(IMAGE_EXCHANGE_LUCKYCOIN_WINDOW_BACK, m_Pos.x, m_Pos.y, float(EXCHANGE_LUCKYCOIN_WINDOW_WIDTH), float(EXCHANGE_LUCKYCOIN_WINDOW_HEIGHT), 0.f, 0.f, (float)((float(EXCHANGE_LUCKYCOIN_WINDOW_WIDTH)) * 4.f), (float)((float(EXCHANGE_LUCKYCOIN_WINDOW_HEIGHT)) * 4.f));
