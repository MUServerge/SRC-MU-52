...
namespace SEASON3B
{
	...
	{
	public:
		// MuDream-style skin (LegendUI\UI_ExitMenu_Window.ozt 388x498, buttons_big.ozt 252x204 = 3 states of 252x68).
		// Layout is in the virtual 640x480 space; window keeps the skin aspect ratio.
		enum
		{
			SYSMENU_WIDTH = 194,
			SYSMENU_HEIGHT = 249,
			SYSMENU_TITLE_TOP = 12,
			SYSMENU_BTN_WIDTH = 126,
			SYSMENU_BTN_HEIGHT = 34,
			SYSMENU_BTN_TOP = 51,
			SYSMENU_BTN_GAP = 4,
		};
