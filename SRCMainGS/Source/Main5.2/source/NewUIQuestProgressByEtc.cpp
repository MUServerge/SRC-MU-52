...
bool CNewUIQuestProgressByEtc::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	m_btnComplete.ChangeButtonImgState(true, BITMAP_msgbox_btn_empty, true, false, false, 0.0, 0.0, 432.f, 116.f);
#else
	m_btnClose.ChangeButtonImgState(true, IMAGE_QPE_BTN_CLOSE);
	m_btnClose.ChangeButtonInfo(x + 13, y + 392, 36, 29);
	m_btnComplete.ChangeButtonImgState(true, IMAGE_QPE_BTN_COMPLETE, true, false, false, 0.f, 0.f, 432.f, 116.f);
#endif
