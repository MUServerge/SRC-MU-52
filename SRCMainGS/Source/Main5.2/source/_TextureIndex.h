...
enum
{
	...
	// CustomNpcQuest on-screen tracker HUD (QuestInfo\*.ozt). 20 slots reserved for headroom.
	BITMAP_INTERFACE_QUESTINFO_HUD_BEGIN,
	BITMAP_INTERFACE_QUESTINFO_HUD_END = BITMAP_INTERFACE_QUESTINFO_HUD_BEGIN + 19,

	// Look5 world/boss health bars (Interface\HealthBar\*.ozt).
	// This range is deliberately independent from QuestInfo and other HUD systems.
	BITMAP_INTERFACE_HEALTHBAR_BEGIN,
	BITMAP_INTERFACE_HEALTHBAR_END = BITMAP_INTERFACE_HEALTHBAR_BEGIN + 15,

	// Active-invasion HUD skin (Interface\ActiveInvasion\*.ozt) - MuDream-style textures used
	// by CGMInvasionManager. Fixed order: background, background_new, arrows, btn, close, plus,
	// minus, notify. Named slots inside the range give stable indices even if the range is later resized.
	BITMAP_INTERFACE_ACTINV_BEGIN,
	BITMAP_INTERFACE_ACTINV_BACKGROUND     = BITMAP_INTERFACE_ACTINV_BEGIN,
	BITMAP_INTERFACE_ACTINV_BACKGROUND_NEW = BITMAP_INTERFACE_ACTINV_BEGIN + 1,
	BITMAP_INTERFACE_ACTINV_ARROWS         = BITMAP_INTERFACE_ACTINV_BEGIN + 2,
	BITMAP_INTERFACE_ACTINV_BTN            = BITMAP_INTERFACE_ACTINV_BEGIN + 3,
	BITMAP_INTERFACE_ACTINV_CLOSE          = BITMAP_INTERFACE_ACTINV_BEGIN + 4,
	BITMAP_INTERFACE_ACTINV_PLUS           = BITMAP_INTERFACE_ACTINV_BEGIN + 5,
	BITMAP_INTERFACE_ACTINV_MINUS          = BITMAP_INTERFACE_ACTINV_BEGIN + 6,
	BITMAP_INTERFACE_ACTINV_NOTIFY         = BITMAP_INTERFACE_ACTINV_BEGIN + 7,	// HUD icon (UI_HUD_NOTIFICATIONS atlas)
	BITMAP_INTERFACE_ACTINV_END            = BITMAP_INTERFACE_ACTINV_BEGIN + 15,

	// Dedicated reconnect-window background (LegendUI\reconnect.ozt) - own slot so it does not
	// touch the shared message-box skin (BITMAP_MESSAGE_WIN).
	BITMAP_INTERFACE_RECONNECT,

	// ESC system-menu skin (LegendUI\UI_ExitMenu_Window.ozt + buttons_big.ozt) - own slots,
	// same pattern as the reconnect window.
	BITMAP_INTERFACE_EXITMENU_WINDOW,
	BITMAP_INTERFACE_EXITMENU_BUTTONS,

	// F5 custom game menu: 16 icons + background/title/tile/close/button skins.
	BITMAP_INTERFACE_MAINMENU_BEGIN,
	BITMAP_INTERFACE_MAINMENU_END = BITMAP_INTERFACE_MAINMENU_BEGIN + 24,

	// Game Option window, Iberia skin and control atlases.
	BITMAP_INTERFACE_OPTION_SKIN_BEGIN,
	BITMAP_INTERFACE_OPTION_SKIN_END = BITMAP_INTERFACE_OPTION_SKIN_BEGIN + 16,

	// Character window, Iberia skin plates.  Action buttons keep their legacy
	// two-state behavior while using the matching Character button family.
	BITMAP_INTERFACE_CHARACTER_SKIN_BEGIN,
	BITMAP_INTERFACE_CHARACTER_SKIN_END = BITMAP_INTERFACE_CHARACTER_SKIN_BEGIN + 11,

	// Inventory window, Iberia skin plates and two-state action buttons.
	BITMAP_INTERFACE_INVENTORY_SKIN_BEGIN,
	BITMAP_INTERFACE_INVENTORY_SKIN_END = BITMAP_INTERFACE_INVENTORY_SKIN_BEGIN + 13,
	...
	BITMAP_BUFFWINDOW_END = BITMAP_BUFFWINDOW_BEGIN + 4,	// STATUS, STATUS2, STATUS3, arrow, arrow_1
	...
	// Dedicated slots for the Look-5 / MuDream HUD (no more reused-button hack).
	// 32 reserved; auto-numbered, stays below the 33000 marker.
	BITMAP_LOOK5_HUD_BEGIN,
	BITMAP_LOOK5_HUD_END = BITMAP_LOOK5_HUD_BEGIN + 31,
	// MuArchangel2-style boot loading screen (KMUA2_*): Back01, Back02, Bar,
	...
	// Luerys Treasure Box notification animation. One slot per OZT frame;
	// currently rendered behind an active Invasion HUD icon.
	BITMAP_INTERFACE_LUERYS_NOTIFY_BEGIN,
	BITMAP_INTERFACE_LUERYS_NOTIFY_END = BITMAP_INTERFACE_LUERYS_NOTIFY_BEGIN + 17,
	// Iberia skill cooldown sequence (Pegasus_CooldownI1..I120.ozt).
	BITMAP_INTERFACE_IBERIA_COOLDOWN_BEGIN,
	BITMAP_INTERFACE_IBERIA_COOLDOWN_END = BITMAP_INTERFACE_IBERIA_COOLDOWN_BEGIN + 119,
	// Iberia HUD notifications: Character, Shield, Swords and Invasion;
	// each icon owns normal, hover and disabled textures.
	BITMAP_INTERFACE_IBERIA_NOTIFICATION_BEGIN,
	BITMAP_INTERFACE_IBERIA_NOTIFICATION_END = BITMAP_INTERFACE_IBERIA_NOTIFICATION_BEGIN + 11,
