...
void SEASON3B::CNewUIMessageBoxMng::LoadImages()
{
	...
	LoadBitmap("Interface\\newui_button_ok.tga", BITMAP_msgbox_btn_ok, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_button_cancel.tga", BITMAP_msgbox_btn_cancel, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_button_close.tga", BITMAP_msgbox_btn_close, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_btn_empty.tga", BITMAP_msgbox_btn_empty, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_btn_empty_small.tga", BITMAP_msgbox_btn_empty_small, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_btn_empty_big.tga", BITMAP_msgbox_btn_empty_big, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
	LoadBitmap("Interface\\newui_btn_empty_very_small.tga", BITMAP_msgbox_btn_empty_very_small, GL_LINEAR, GL_CLAMP_TO_EDGE, true, false);
