...
void CMsgBoxIGSBuyConfirm::RenderFrame()
{
	...
	RenderImageF(IMAGE_IGS_BACK, GetPos().x, iY, IMAGE_IGS_FRAME_WIDTH, IMAGE_IGS_FRAME_HEIGHT, 0.f, 0.f, (float)((IMAGE_IGS_FRAME_WIDTH) * 4.f), (float)((IMAGE_IGS_FRAME_HEIGHT) * 4.f));
	...
	RenderImageF(IMAGE_IGS_DOWN, GetPos().x, iY, IMAGE_IGS_FRAME_WIDTH, IMAGE_IGS_DOWN_HEIGHT, 0.f, 0.f, 760.f, 180.f);
	RenderImageF(IMAGE_IGS_TEXTBOX,
		GetPos().x + IGS_TEXTBOX_POS_X, GetPos().y + IGS_TEXTBOX_POS_Y,
		IMAGE_IGS_TEXTBOX_WIDTH, IMAGE_IGS_TEXTBOX_HEIGHT,
		0.0f, 0.0f, IMAGE_IGS_TEXTBOX_WIDTH * 4.0f, IMAGE_IGS_TEXTBOX_HEIGHT * 4.0f);
