...
void SEASON3B::CNewUICatapultWindow::SetButtonInfo()
{
	...
	m_BtnFire.ChangeButtonImgState(true, IMAGE_CATAPULT_BTN_FIRE, true, false, false, 0.f, 0.f, 432.f, 116.f);
...
{
	RenderImageF(IMAGE_CATAPULT_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_CATAPULT_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_CATAPULT_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_CATAPULT_RIGHT, m_Pos.x + 190 - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_CATAPULT_BOTTOM, m_Pos.x, m_Pos.y + 429 - 45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
}
...
void SEASON3B::CNewUICatapultWindow::RenderOutlineUpper(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_CATAPULT_TABLE_TOP_RIGHT, ptOrigin.x + fBoxWidth + 4, ptOrigin.y - 4, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CATAPULT_TABLE_TOP_PIXEL, ptOrigin.x + 25, ptOrigin.y - 4, fBoxWidth - 21, 14, 0.f, 0.f, (float)((fBoxWidth - 21) * 4.f), 56.f);
}
...
void SEASON3B::CNewUICatapultWindow::RenderOutlineLower(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_CATAPULT_TABLE_LEFT_PIXEL, ptOrigin.x + 12, ptOrigin.y + 9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_CATAPULT_TABLE_RIGHT_PIXEL, ptOrigin.x + fBoxWidth + 4, ptOrigin.y + 9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_CATAPULT_TABLE_BOTTOM_LEFT, ptOrigin.x + 12, ptOrigin.y + fBoxHeight + 3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CATAPULT_TABLE_BOTTOM_RIGHT, ptOrigin.x + fBoxWidth + 4, ptOrigin.y + fBoxHeight + 3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_CATAPULT_TABLE_BOTTOM_PIXEL, ptOrigin.x + 25, ptOrigin.y + fBoxHeight + 3, fBoxWidth - 21, 14, 0.f, 0.f, (float)((fBoxWidth - 21) * 4.f), 56.f);
}
