...
// Must stay byte-identical to the client's CUSTOM_NPC_ICON (supportingfeature.h)
// so the av-code45.pak vector round-trips.
class CUSTOM_NPC_ICON
{
public:
	int IndexNpc;
	int WorldIndex;
...
extern void runtime_unique_document_file(std::string filename, std::vector<CUSTOM_NPC_ICON>& item_info, size_t size);
