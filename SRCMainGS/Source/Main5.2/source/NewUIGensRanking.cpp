...
namespace
{
	const float GENS_RANK_TEXTBOX_TEXTURE_SCALE = 4.0f;
	const float GENS_INFO_FRAME_TEXTURE_SCALE = 2.0f;
}
...
{
	RenderImageF(IMAGE_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_LEFT, m_Pos.x, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_RIGHT, m_Pos.x+GENSRANKING_WIDTH-21, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_BOTTOM, m_Pos.x, m_Pos.y+GENSRANKING_HEIGHT-45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
	...
	RenderImageF(IMAGE_RANKBACK_TEXTBOX,
		m_Pos.x + 13, m_Pos.y + GENSRANKBACK_HEIGHT + 63,
		GENSRANKTEXTBACK_WIDTH, GENSRANKTEXTBACK_HEIGHT,
		0.0f, 0.0f,
		GENSRANKTEXTBACK_WIDTH * GENS_RANK_TEXTBOX_TEXTURE_SCALE,
		GENSRANKTEXTBACK_HEIGHT * GENS_RANK_TEXTBOX_TEXTURE_SCALE);
	RenderImageF(IMAGE_RANKBACK_TEXTBOX,
		m_Pos.x + 13, m_Pos.y + GENSRANKBACK_HEIGHT + GENSRANKTEXTBACK_HEIGHT + 66,
		GENSRANKTEXTBACK_WIDTH, GENSRANKTEXTBACK_HEIGHT,
		0.0f, 0.0f,
		GENSRANKTEXTBACK_WIDTH * GENS_RANK_TEXTBOX_TEXTURE_SCALE,
		GENSRANKTEXTBACK_HEIGHT * GENS_RANK_TEXTBOX_TEXTURE_SCALE);
...
void CNewUIGensRanking::RenderInfoFrame(int iPosX, int iPosY, int iWidth, int iHeight, int iTitleWidth, int iTitleHeight)
{
	...
	const float cornerSize = 14.0f;
	const float cornerTextureSize = cornerSize * GENS_INFO_FRAME_TEXTURE_SCALE;
	RenderImageF(IMAGE_GENSINFO_TOP_LEFT, iPosX, iPosY, cornerSize, cornerSize, 0.0f, 0.0f, cornerTextureSize, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_TOP_RIGHT, iPosX + iTitleWidth - 14, iPosY, cornerSize, cornerSize, 0.0f, 0.0f, cornerTextureSize, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_TOP_RIGHT, iPosX + iWidth - 14, iPosY + iTitleHeight, cornerSize, cornerSize, 0.0f, 0.0f, cornerTextureSize, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_BOTTOM_LEFT, iPosX, iPosY + iHeight - 14, cornerSize, cornerSize, 0.0f, 0.0f, cornerTextureSize, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_BOTTOM_RIGHT, iPosX + iWidth - 14, iPosY + iHeight - 14, cornerSize, cornerSize, 0.0f, 0.0f, cornerTextureSize, cornerTextureSize);

	const float titleTopWidth = (float)(iTitleWidth - 12);
	const float bodyTopWidth = (float)(iWidth - iTitleWidth - 6);
	const float bottomWidth = (float)(iWidth - 12);
	const float titleRightHeight = (float)(iTitleHeight - 6);
	const float bodyRightHeight = (float)(iHeight - iTitleHeight - 14);
	const float leftHeight = (float)(iHeight - 14);
	RenderImageF(IMAGE_GENSINFO_TOP_PIXEL, iPosX + 6, iPosY, titleTopWidth, cornerSize, 0.0f, 0.0f, titleTopWidth * GENS_INFO_FRAME_TEXTURE_SCALE, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_RIGHT_PIXEL, iPosX + iTitleWidth - 14, iPosY + 6, cornerSize, titleRightHeight, 0.0f, 0.0f, cornerTextureSize, titleRightHeight * GENS_INFO_FRAME_TEXTURE_SCALE);
	RenderImageF(IMAGE_GENSINFO_TOP_PIXEL, iPosX + iTitleWidth - 5, iPosY + iTitleHeight, bodyTopWidth, cornerSize, 0.0f, 0.0f, bodyTopWidth * GENS_INFO_FRAME_TEXTURE_SCALE, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_RIGHT_PIXEL, iPosX + iWidth - 14, iPosY + iTitleHeight + 6, cornerSize, bodyRightHeight, 0.0f, 0.0f, cornerTextureSize, bodyRightHeight * GENS_INFO_FRAME_TEXTURE_SCALE);
	RenderImageF(IMAGE_GENSINFO_BOTTOM_PIXEL, iPosX + 6, iPosY + iHeight - 14, bottomWidth, cornerSize, 0.0f, 0.0f, bottomWidth * GENS_INFO_FRAME_TEXTURE_SCALE, cornerTextureSize);
	RenderImageF(IMAGE_GENSINFO_LEFT_PIXEL, iPosX, iPosY + 6, cornerSize, leftHeight, 0.0f, 0.0f, cornerTextureSize, leftHeight * GENS_INFO_FRAME_TEXTURE_SCALE);
}
