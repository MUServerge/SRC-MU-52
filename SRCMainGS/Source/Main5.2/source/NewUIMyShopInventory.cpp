...
bool SEASON3B::CNewUIMyShopInventory::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	else
	{
		...
		m_Button[MYSHOPINVENTORY_OPEN].ChangeButtonImgState(true, IMAGE_MYSHOPINVENTORY_OPEN, false, false, false, 0.f, 0.f, 144.f, 116.f);
		m_Button[MYSHOPINVENTORY_OPEN].ChangeButtonInfo(m_Pos.x + 53, m_Pos.y + 391, 36, 29);

		m_Button[MYSHOPINVENTORY_CLOSE].ChangeButtonImgState(true, IMAGE_MYSHOPINVENTORY_CLOSE, false, false, false, 0.f, 0.f, 144.f, 116.f);
...
void SEASON3B::CNewUIMyShopInventory::RenderFrame()
{
	...
	{
		SEASON3B::RenderImageF(IMAGE_MYSHOPINVENTORY_EDIT, m_Pos.x + 12, m_Pos.y + 49, 169.f, 26.f, 0.f, 0.f, 680.f, 104.f);
	}
