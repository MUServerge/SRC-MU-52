...
void SEASON3B::CNewUIStorageExpansion::RenderFrame()
{
	...
	{
		RenderImageF(IMAGE_STORAGE_BACK, m_Pos.x, m_Pos.y, 190.0, 429.0, 0.f, 0.f, (float)((190.0) * 4.f), (float)((429.0) * 4.f));
		RenderImageF(IMAGE_STORAGE_TOP, m_Pos.x, m_Pos.y, 190.0, 64.f, 0.f, 0.f, 760.f, 256.f);
		RenderImageF(IMAGE_STORAGE_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_STORAGE_RIGHT, m_Pos.x + 190.0 - 21, m_Pos.y + 64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
		RenderImageF(IMAGE_STORAGE_BOTTOM, m_Pos.x, m_Pos.y + 429.0 - 45, 190.0, 45.f, 0.f, 0.f, 760.f, 180.f);
	}
#endif // test_main_dev
}
