...
// Renderer diagnostics are routed through the existing profiler. The four GL
// wrappers in this header keep the original call order and become counter-only
// when MU_RENDER_PROFILER=1 is present before process start.
