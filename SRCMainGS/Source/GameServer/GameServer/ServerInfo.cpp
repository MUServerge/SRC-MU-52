...
void CServerInfo::ReadCharacterInfo(char* section, char* path) // OK
{
	...
	this->m_ClassReflectDamageRatePvP[0] = GetPrivateProfileInt(section, "DWReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[1] = GetPrivateProfileInt(section, "DKReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[2] = GetPrivateProfileInt(section, "FEReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[3] = GetPrivateProfileInt(section, "MGReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[4] = GetPrivateProfileInt(section, "DLReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[5] = GetPrivateProfileInt(section, "SUReflectDamageRatePvP", 0, path);

#if(GAMESERVER_UPDATE>=601)

	this->m_ClassReflectDamageRatePvP[CLASS_RF] = GetPrivateProfileInt(section, "RFReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_GL] = GetPrivateProfileInt(section, "GLReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_RW] = GetPrivateProfileInt(section, "RWReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_SL] = GetPrivateProfileInt(section, "SLReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_GC] = GetPrivateProfileInt(section, "GCReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_KUN] = GetPrivateProfileInt(section, "KUNReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_LEM] = GetPrivateProfileInt(section, "LEMReflectDamageRatePvP", 0, path);

	this->m_ClassReflectDamageRatePvP[CLASS_KIN] = GetPrivateProfileInt(section, "KINReflectDamageRatePvP", 0, path);
#endif

	this->m_ClassReflectDamageRatePvM[0] = GetPrivateProfileInt(section, "DWReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[1] = GetPrivateProfileInt(section, "DKReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[2] = GetPrivateProfileInt(section, "FEReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[3] = GetPrivateProfileInt(section, "MGReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[4] = GetPrivateProfileInt(section, "DLReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[5] = GetPrivateProfileInt(section, "SUReflectDamageRatePvM", 0, path);

#if(GAMESERVER_UPDATE>=601)

	this->m_ClassReflectDamageRatePvM[CLASS_RF] = GetPrivateProfileInt(section, "RFReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_GL] = GetPrivateProfileInt(section, "GLReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_RW] = GetPrivateProfileInt(section, "RWReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_SL] = GetPrivateProfileInt(section, "SLReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_GC] = GetPrivateProfileInt(section, "GCReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_KUN] = GetPrivateProfileInt(section, "KUNReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_LEM] = GetPrivateProfileInt(section, "LEMReflectDamageRatePvM", 0, path);

	this->m_ClassReflectDamageRatePvM[CLASS_KIN] = GetPrivateProfileInt(section, "KINReflectDamageRatePvM", 0, path);
#endif
