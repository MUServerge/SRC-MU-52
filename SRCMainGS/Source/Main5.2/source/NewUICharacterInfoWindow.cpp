...
void SEASON3B::CNewUICharacterInfoWindow::SetButtonInfo()
{
	...
	if (gmProtect->checkold_school())
	{
		...
		{
			m_BtnStat[i].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		}
		...
		m_BtnExit.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_EXIT, false, false, false, 0.f, 0.f, 144.f, 116.f);
		m_BtnExit.ChangeButtonInfo(m_Pos.x + 13, m_Pos.y + 392, 36, 29);

		m_BtnQuest.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_QUEST, false, false, false, 0.f, 0.f, 144.f, 116.f);
		m_BtnQuest.ChangeButtonInfo(m_Pos.x + 50, m_Pos.y + 392, 36, 29);

		m_BtnPet.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_PET, false, false, false, 0.f, 0.f, 144.f, 116.f);
		m_BtnPet.ChangeButtonInfo(m_Pos.x + 87, m_Pos.y + 392, 36, 29);

		if (GMProtect->IsMasterSkill() == true)
		{
			m_BtnMasterLevel.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_MASTERLEVEL, false, false, false, 0.f, 0.f, 144.f, 116.f);
	...
	{
		m_BtnStat[STAT_STRENGTH].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		m_BtnStat[STAT_STRENGTH].ChangeButtonInfo(m_Pos.x + 160, m_Pos.y + HEIGHT_STRENGTH + 2, 16, 15);

		m_BtnStat[STAT_DEXTERITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		m_BtnStat[STAT_DEXTERITY].ChangeButtonInfo(m_Pos.x + 160, m_Pos.y + HEIGHT_DEXTERITY + 2, 16, 15);

		m_BtnStat[STAT_VITALITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		m_BtnStat[STAT_VITALITY].ChangeButtonInfo(m_Pos.x + 160, m_Pos.y + HEIGHT_VITALITY + 2, 16, 15);

		m_BtnStat[STAT_ENERGY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		m_BtnStat[STAT_ENERGY].ChangeButtonInfo(m_Pos.x + 160, m_Pos.y + HEIGHT_ENERGY + 2, 16, 15);

		m_BtnStat[STAT_CHARISMA].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false, false, false, 0.f, 0.f, 64.f, 60.f);
		m_BtnStat[STAT_CHARISMA].ChangeButtonInfo(m_Pos.x + 160, m_Pos.y + HEIGHT_CHARISMA + 2, 16, 15);
...
void SEASON3B::CNewUICharacterInfoWindow::RenderFrame()
{
	...
	if (gmProtect->checkold_school())
	{
		...
		{
			RenderTable(m_Pos.x + 12, m_Pos.y + 64, 166, 56);
			RenderImageF(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 11, m_Pos.y + HEIGHT_STRENGTH, 170.f, 21.f, 0.f, 0.f, 680.f, 84.f);
			RenderImageF(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 11, m_Pos.y + HEIGHT_DEXTERITY, 170.f, 21.f, 0.f, 0.f, 680.f, 84.f);
			RenderImageF(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 11, m_Pos.y + HEIGHT_VITALITY, 170.f, 21.f, 0.f, 0.f, 680.f, 84.f);
			RenderImageF(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 11, m_Pos.y + HEIGHT_ENERGY, 170.f, 21.f, 0.f, 0.f, 680.f, 84.f);

			if (Hero->GetBaseClass() == CLASS_DARK_LORD)
			{
				RenderImageF(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 11, m_Pos.y + HEIGHT_CHARISMA, 170.f, 21.f, 0.f, 0.f, 680.f, 84.f);
			}
		}
	}
	else
