...
void CB_Interface::DrawInfoBox(float PosX, float PosY, float Width, float Height, DWORD bkcolor, int Arg6, int Arg7)
{
	...
	while (vertical || horizontal)
	{
		if (vertical)
		{
			...
			RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_TOP_PIXEL, IniciarX, TopY, w, 14.0f, 0.f, 0.f, (float)((w) * 4.f), 56.f); //Ngang

			RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_BOTTOM_PIXEL, IniciarX, DownY, w, 14.0f, 0.f, 0.f, (float)((w) * 4.f), 56.f); //Ngang 2
		}
		//-- abajo
		if (horizontal)
		{
			...
			RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_RIGHT_PIXEL, LeftX, IniciarY, 14.0f, H, 0.f, 0.f, 56.f, (float)((H) * 4.f)); //Doc 2

			RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_LEFT_PIXEL, RightX, IniciarY, 14.0f, H, 0.f, 0.f, 56.f, (float)((H) * 4.f)); // Doc 1
	...
	RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_TOP_RIGHT, LeftX, TopY, 14.0f, 14.0f, 0.f, 0.f, 56.f, 56.f); //Goc tren ben phai

	RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_BOTTOM_LEFT, RightX, DownY, 14.0f, 14.0f, 0.f, 0.f, 56.f, 56.f);  //Goc duoi trai

	RenderImageF(CNewUIInventoryCtrl::IMAGE_ITEM_TABLE_BOTTOM_RIGHT, LeftX, DownY, 14.0f, 14.0f, 0.f, 0.f, 56.f, 56.f);  //Goc Duoi phai
	glColor3f(1, 1, 1);
	EnableAlphaTest(false);
}
