...
void CNewUIDoppelGangerWindow::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_DOPPELGANGERWINDOW_BUTTON, true, false, false, 0.f, 0.f, 216.f, 92.f );
...
bool CNewUIDoppelGangerWindow::Render()
{
	...
	//{
	//	RenderImageF(IMAGE_DOPPELGANGERWINDOW_LINE, m_Pos.x + 1, m_Pos.y + 130 + 90, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
	//}
...
void CNewUIDoppelGangerWindow::RenderFrame()
{
	...
	//else
	//{
	//	RenderImageF(IMAGE_DOPPELGANGERWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
