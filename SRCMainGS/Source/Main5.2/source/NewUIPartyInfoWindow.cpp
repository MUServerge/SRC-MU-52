...
void CNewUIPartyInfoWindow::RenderGroupBox(int iPosX, int iPosY, int iWidth, int iHeight, int iTitleWidth/* =60 */, int iTitleHeight/* =20  */)
{
	...
	RenderImageF(IMAGE_PARTY_TABLE_TOP_RIGHT, iPosX + iTitleWidth - 14, iPosY, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_TOP_RIGHT, iPosX + iWidth - 14, iPosY + iTitleHeight, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_BOTTOM_LEFT, iPosX, iPosY + iHeight - 14, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_BOTTOM_RIGHT, iPosX + iWidth - 14, iPosY + iHeight - 14, 14, 14, 0.f, 0.f, 56.f, 56.f);

	RenderImageF(IMAGE_PARTY_TABLE_TOP_PIXEL, iPosX + 6, iPosY, iTitleWidth - 12, 14, 0.f, 0.f, (float)((iTitleWidth - 12) * 4.f), 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_RIGHT_PIXEL, iPosX + iTitleWidth - 14, iPosY + 6, 14, iTitleHeight - 6, 0.f, 0.f, 56.f, (float)((iTitleHeight - 6) * 4.f));
	RenderImageF(IMAGE_PARTY_TABLE_TOP_PIXEL, iPosX + iTitleWidth - 5, iPosY + iTitleHeight, iWidth - iTitleWidth - 6, 14, 0.f, 0.f, (float)((iWidth - iTitleWidth - 6) * 4.f), 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_RIGHT_PIXEL, iPosX + iWidth - 14, iPosY + iTitleHeight + 6, 14, iHeight - iTitleHeight - 14, 0.f, 0.f, 56.f, (float)((iHeight - iTitleHeight - 14) * 4.f));
	RenderImageF(IMAGE_PARTY_TABLE_BOTTOM_PIXEL, iPosX + 6, iPosY + iHeight - 14, iWidth - 12, 14, 0.f, 0.f, (float)((iWidth - 12) * 4.f), 56.f);
	RenderImageF(IMAGE_PARTY_TABLE_LEFT_PIXEL, iPosX, iPosY + 6, 14, iHeight - 14, 0.f, 0.f, 56.f, (float)((iHeight - 14) * 4.f));
}
