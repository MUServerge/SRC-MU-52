...
bool CNewUIGoldBowmanLena::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	// Register Button
	m_BtnRegister.ChangeButtonImgState( true, IMAGE_GBL_BTN_SERIAL, false, false, false, 0.f, 0.f, 432.f, 116.f );
...
{
	// frame
	RenderImageF(IMAGE_GBL_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_GBL_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_GBL_LEFT, m_Pos.x, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GBL_RIGHT, m_Pos.x+INVENTORY_WIDTH-21, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GBL_BOTTOM, m_Pos.x, m_Pos.y+INVENTORY_HEIGHT-45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
}
