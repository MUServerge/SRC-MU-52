...
void CNewUIGateSwitchWindow::InitButton(CNewUIButton * pNewUIButton, int iPos_x, int iPos_y, const unicode::t_char * pCaption)
{
	...
	pNewUIButton->ChangeButtonImgState( true, IMAGE_GATESWITCHWINDOW_BUTTON, true, false, false, 0.f, 0.f, 432.f, 116.f );
...
{
	RenderImageF(IMAGE_GATESWITCHWINDOW_BACK, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.f, 0.f, (float)((190.f) * 4.f), (float)((429.f) * 4.f));
	RenderImageF(IMAGE_GATESWITCHWINDOW_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f, 0.f, 0.f, 760.f, 256.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_LEFT, m_Pos.x, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_RIGHT, m_Pos.x+INVENTORY_WIDTH-21, m_Pos.y+64, 21.f, 320.f, 0.f, 0.f, 84.f, 1280.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_BOTTOM, m_Pos.x, m_Pos.y+INVENTORY_HEIGHT-45, 190.f, 45.f, 0.f, 0.f, 760.f, 180.f);
...
void CNewUIGateSwitchWindow::RenderOutlineUpper(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_TOP_RIGHT, ptOrigin.x+fBoxWidth+4, ptOrigin.y-4, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_TOP_PIXEL, ptOrigin.x+25, ptOrigin.y-4, fBoxWidth-21, 14, 0.f, 0.f, (float)((fBoxWidth-21) * 4.f), 56.f);
}
...
void CNewUIGateSwitchWindow::RenderOutlineLower(float fPos_x, float fPos_y, float fWidth, float fHeight)
{
	...
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_LEFT_PIXEL, ptOrigin.x+12, ptOrigin.y+9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_RIGHT_PIXEL, ptOrigin.x+fBoxWidth+4, ptOrigin.y+9, 14, fBoxHeight, 0.f, 0.f, 56.f, (float)((fBoxHeight) * 4.f));
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_BOTTOM_LEFT, ptOrigin.x+12, ptOrigin.y+fBoxHeight+3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_BOTTOM_RIGHT, ptOrigin.x+fBoxWidth+4, ptOrigin.y+fBoxHeight+3, 14, 14, 0.f, 0.f, 56.f, 56.f);
	RenderImageF(IMAGE_GATESWITCHWINDOW_TABLE_BOTTOM_PIXEL, ptOrigin.x+25, ptOrigin.y+fBoxHeight+3, fBoxWidth-21, 14, 0.f, 0.f, (float)((fBoxWidth-21) * 4.f), 56.f);
}
