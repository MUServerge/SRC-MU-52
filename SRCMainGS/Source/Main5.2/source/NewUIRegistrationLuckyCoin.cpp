...
#if MAIN_UPDATE > 603
		m_RegistButton.ChangeButtonImgState(true, BITMAP_msgbox_btn_empty_very_small, true, false, false, 0.0, 0.0, 216.f, 92.f);
#else
...
#if MAIN_UPDATE > 603
		m_CloseButton.ChangeButtonImgState(true, BITMAP_msgbox_btn_empty_very_small, true, false, false, 0.0, 0.0, 216.f, 92.f);
#else
