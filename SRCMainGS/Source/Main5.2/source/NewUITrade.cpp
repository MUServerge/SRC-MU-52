...
bool CNewUITrade::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	else
	{
		...
		m_abtn[BTN_ZEN_INPUT].ChangeButtonImgState(true, IMAGE_TRADE_BTN_ZEN_INPUT, false, false, false, 0.f, 0.f, 144.f, 116.f);
...
void CNewUITrade::RenderBackImage()
{
	...
	if (gmProtect->checkold_school())
	{
		...
		{
			RenderImageF(IMAGE_TRADE_MONEY, m_Pos.x + 11, m_Pos.y + 150, 170.f, 26.f, 0.f, 0.f, 680.f, 104.f);

			RenderImageF(IMAGE_TRADE_MONEY, m_Pos.x + 11, m_Pos.y + 356, 170.f, 26.f, 0.f, 0.f, 680.f, 104.f);
		}
	...
	{
		//RenderImageF(IMAGE_TRADE_LINE, m_Pos.x + 1, m_Pos.y + 220, 188.f, 21.f, 0.f, 0.f, (float)((188.f) * 4.f), (float)((21.f) * 4.f));
		SEASON3B::RenderImageF(IMAGE_TRADE_NICK_BACK, m_Pos.x + 11, m_Pos.y + 37, 171.f, 26.f, 0.f, 0.f, 680.f, 112.f);
		RenderImageF(IMAGE_TRADE_MONEY, m_Pos.x + 11, m_Pos.y + 150, 170.f, 26.f, 0.f, 0.f, 680.f, 104.f);
		SEASON3B::RenderImageF(IMAGE_TRADE_NICK_BACK, m_Pos.x + 11, m_Pos.y + 243, 171.f, 26.f, 0.f, 0.f, 680.f, 112.f);
		RenderImageF(IMAGE_TRADE_MONEY, m_Pos.x + 11, m_Pos.y + 356, 170.f, 26.f, 0.f, 0.f, 680.f, 104.f);

		float fSrcY = m_bYourConfirm ? 116.f : 0.f;
		SEASON3B::RenderImageF(IMAGE_TRADE_CONFIRM, m_Pos.x + 146, m_Pos.y + 186, CONFIRM_WIDTH, CONFIRM_HEIGHT, 0.f, fSrcY, 144.f, 116.f);

		DWORD dwColor = m_nMyTradeWait > 0 ? RGBA(255, 0, 0, 255) : RGBA(255, 255, 255, 255);

		fSrcY = m_bMyConfirm ? 116.f : 0.f;
		SEASON3B::RenderImageF(IMAGE_TRADE_CONFIRM, m_posMyConfirm.x, m_posMyConfirm.y, CONFIRM_WIDTH, CONFIRM_HEIGHT, dwColor, 0.f, fSrcY, 144.f, 116.f);
	}
#else
	if (gmProtect->trade_system_pro)
	{
