...
void OpenPlayerTextures()
{
	...
	LoadBitmap("Player\\HQSkinClass408.jpg", BITMAP_HQSKIN + 7, GL_NEAREST, GL_CLAMP_TO_EDGE, true, false);
...
{
	InitPath();
	LoadBitmap("Interface\\FontInput.tga", BITMAP_FONT, GL_LINEAR, GL_CLAMP_TO_EDGE);
